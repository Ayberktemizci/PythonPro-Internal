...
ui: {
  ...
  heroSub: 'Percorra cada módulo em ordem e passe no teste para concluir sua preparação como tutor. Tire 70% ou mais no teste de um módulo para desbloquear o próximo — não dá para pular etapas, e o Teste de Habilidades Digitais só abre quando todos os módulos estiverem concluídos.',
  ...
  completeSub: 'Você percorreu todos os módulos — parabéns! Está pronto para o Teste de Habilidades Digitais.',
  ...
  takeDST: '🎯 Fazer o Teste de Habilidades Digitais →',
  ...
  practicalNote: 'Isto é uma autodeclaração — ninguém consegue verificar por aqui. Marque com honestidade: o teste do módulo só confirma que você leu, não que consiga fazer.',
...
dst: {
  ...
  html: `<div class="dst-body">
    ...
    <div class="dst-block">
      ...
      <a class="dst-form-btn" href="https://forms.gle/33bS928yyp5N9tPFA" target="_blank" rel="noopener noreferrer">📝 Abrir o teste de habilidade →</a>
        <p class="dst-note" style="margin-top:12px">Abre o formulário em uma nova aba. Antes de enviar, confirme que o repositório está público e que nenhum token ficou no código.</p>
      </div>
...
faq: [
  ...
  },
  {
    ...
    items: [
      {q: 'Um aluno pergunta algo que eu realmente não sei.', a: 'O padrão é <strong>“Ótima pergunta, não tenho certeza. Vamos descobrir — onde a gente procuraria?”</strong> e então procurar de verdade, com a tela compartilhada. Essa é a aula M1L4 acontecendo ao vivo: ninguém sabe de cor uma biblioteca, e encontrar a resposta <em>é</em> a habilidade profissional. Se estiver no meio de um sprint e sem tempo, adie: “quero responder isso direito — volto no chat do grupo hoje à noite.” E volte mesmo. A única resposta que realmente te prejudica é um palpite dado com confiança, porque os alunos conferem durante a aula.'},
  ...
  },
  {
    ...
    items: [
      ...
      {q: 'Um aluno domina a discussão e responde tudo.', a: 'Use as estruturas que já estão nos planos: o jogo da “bola” em M1L3, no qual quem fala escolhe o próximo; o jogo do especialista “todos contra um” em M6L1; e a regra de que o mesmo aluno não responde duas vezes seguidas no jogo da velha de M5L4. Deixe o formato distribuir a fala para você não precisar fazer isso.'}
    ]
  },
  {
...
modules: [
  {
    ...
    obj:'Entenda o quadro completo antes de ensinar qualquer parte: o que o curso Python Pro se propõe a fazer, seus dez módulos e quarenta aulas, os projetos e a faixa etária, os métodos de ensino em que se apoia, o perfil de um tutor bem-sucedido e de um aluno bem-sucedido, e como este programa de formação está estruturado.',
    ...
    sections:[
      {t:'🐍 O que é este curso', cards:[
        ...
        {type:'qa', h:'O que eles realmente entregam', items:[
          ...
          {k:'Bloco de IA', v:'Scripts de troca de fundo de imagem, um coletor de notícias, um resumidor com PLN, um classificador de imagens treinado, uma submissão para a competição real-vs-IA e um detector de objetos para segurança no trânsito.'},
      ...
      {t:'🧭 A filosofia de ensino', cards:[
        {type:'good', txt:'A regra que aparece em quase todo plano de aula: <strong>não escreva o código para os alunos e não entregue as respostas.</strong> Faça perguntas orientadoras, deixe que pensem em voz alta, deixe que se ajudem. Seu trabalho é desbloquear, não resolver.'},
        ...
        {type:'text', h:'Experimentar e depois explicar', b:'Várias aulas fornecem código intencionalmente <em>antes</em> da explicação e pedem que descubram o que ele faz — o bot do Discord em M1L3, o template Jinja em M3L2, os notebooks em M5. Resista à tentação de explicar cedo demais. Cinco minutos de “mude algo e rode de novo” geram perguntas melhores do que qualquer exposição.'},
  ...
  },
  {
    ...
    obj:'Reduza a lacuna entre “sei o básico de Python” e “consigo explicar cada linha do código do curso”. Todas as construções aqui aparecem nas aulas que você vai dar, e o currículo não para para explicar nenhuma delas. Você precisa de duas coisas para cada uma: entendimento sólido o bastante para não estar blefando, e uma frase que dê para dizer a alguém de 14 anos.',
    prep:'~2 a 3 horas. Digite cada exemplo você mesmo, em vez de apenas ler.',
    practical:{
      intro:'Este módulo é o único em que ler realmente não basta — esses conceitos só são fixados depois que você as executa. Antes do teste, passe por todas elas num arquivo de rascunho:',
      items:[
        'Escrever um decorador do zero e vê-lo envolver uma função',
        'Escrever e executar uma função <code>async def</code> com <code>await asyncio.sleep(1)</code> e entender por que o loop importa',
        'Definir uma classe com <code>__init__</code> e <code>self</code>, criar dois objetos a partir dela e dar valores diferentes a cada um',
        'Fazer uma classe herdar de outra e chamar o método da superclasse',
        'Adicionar um <code>__repr__</code> e ver o que muda quando você imprime o objeto',
        'Reescrever um pequeno laço <code>for</code> como list comprehension, e uma função de duas linhas como <code>lambda</code>',
        'Executar uma função que recebe <code>*args</code> e imprimir o que <code>args</code> realmente é'
      ]
    },
    sections:[
      ...
      {t:'🎀 Decoradores — o símbolo @', cards:[
        {type:'text', h:'O que é de fato', b:'Um <strong>decorador</strong> é uma função que recebe outra função, adiciona um comportamento extra a ela e a devolve. A linha com <code>@</code> é um atalho: escrever <code>@meu_decorador</code> acima de <code>def saudar()</code> significa “pegue <code>saudar</code>, passe por <code>meu_decorador</code> e faça com que o resultado seja o novo comportamento de <code>saudar</code>”.'},
...
<span class="cc">#   saudar = gritar(saudar)</span>`},
        ...
        {type:'hi', h:'A frase para dizer ao aluno', b:'“A linha com <code>@</code> é uma etiqueta que você cola numa função para a biblioteca saber para que ela serve. <code>@app.route("/")</code> é uma etiqueta dizendo ‘rode esta aqui quando alguém abrir a página inicial’. Você nunca a chama — o Flask chama por você quando alguém entra no site.” Para alunos mais velhos ou mais rápidos, dá para acrescentar: é uma função que envolve outra função.'},
        {type:'warn', txt:'Uma diferença que vale conhecer para você não parecer inconsistente: <code>@bot.event</code> não tem parênteses, <code>@bot.command()</code> tem. Os dois estão corretos como aparecem no código do curso. A versão com parênteses é uma <em>fábrica</em> de decoradores — pode receber opções como <code>@bot.command(name="pw")</code>, então precisa ser chamado primeiro para produzir o decorador de verdade. Se um aluno perguntar, “aquele ali aceita configurações, por isso precisa dos próprios parênteses” é uma resposta verdadeira e suficiente.'}
      ]},
      {t:'⏳ async e await', cards:[
        {type:'text', h:'O problema que isso resolve', b:'Um bot do Discord passa quase todo o tempo <strong>esperando</strong> — por uma mensagem, pela confirmação de envio do Discord, pela resposta de uma API. A espera síncrona em Python bloqueia tudo: enquanto uma linha espera, nada mais acontece, então o bot ficaria surdo enquanto responde a uma única mensagem. O <code>async</code> permite que uma função pause num ponto de espera e permita que outras tarefas sejam executadas enquanto isso.'},
        {type:'qa', h:'As três palavras, em termos simples', items:[
          ...
          {k:'await', v:'“Pause aqui até isto terminar, e permita que outras tarefas sejam executadas enquanto esperamos.” Só pode ser usado dentro de um <code>async def</code>.'},
          {k:'O event loop', v:'O gerente que mantém a execução das funções pausadas. No curso, o discord.py o inicia por você dentro de <code>bot.run(...)</code> — por isso nada precisa ser configurado.'}
        ]},
...
<span class="cc"># Se você esquecer o await e nada é enviado — você recebe um aviso sobre uma</span>
<span class="cc"># "coroutine was never awaited". É o bug de async nº 1 dos alunos.</span>`},
        {type:'warn', txt:'A falha que os alunos vão de fato produzir: escrever <code>ctx.send("Oi")</code> sem <code>await</code>. Nenhuma mensagem aparece e o console menciona uma coroutine que nunca foi aguardada. Aprenda a reconhecer essa mensagem — ela significa “você criou a tarefa mas nunca permitiu que ela rodasse”. Note também que as funções de áudio e de API do curso <em>não</em> são async, então um comando de bot mistura chamadas com await (Discord) e chamadas comuns (<code>speak()</code>, <code>requests.get()</code>).'},
        {type:'hi', h:'A frase para dizer ao aluno', b:'“<code>async</code> quer dizer que esta função pode esperar sem congelar o bot inteiro, e <code>await</code> marca o ponto onde ela espera. Pense em um garçom que anota o pedido de outra mesa enquanto a cozinha prepara o prato — em vez de ficar parado até a comida ficar pronta.”'},
...
<span class="cf">total</span>(<span class="cn">100</span>, <span class="cn">200</span>, <span class="cn">300</span>)        <span class="cc"># funciona com qualquer quantidade</span>`},
  ...
  },
  {
    ...
    prep:'~1 hora.',
    practical:{
      intro:'Antes do teste, familiarize-se com os materiais reais:',
      items:[
        'Ler um plano de aula completo do PDF do currículo do início ao fim, incluindo a tabela de etapas',
        'Identificar nesse plano: o briefing, o problema, os objetivos, a teoria, a prática e a reflexão',
        'Encontrar a nota no topo do plano que nomeia o método de ensino usado',
        'Descobrir o que a versão individual de 50 minutos dessa aula teria de cortar'
      ]
    },
    sections:[
      {t:'🧭 Por que isto vem antes do conteúdo', cards:[
        {type:'brief',
          overview:'Cada uma das 40 aulas compartilha uma estrutura — <strong>briefing → checagem da lição → o problema → os objetivos → teoria → prática → reflexão</strong> — e se apoia em cinco métodos específicos: <strong>EduScrum</strong>, <strong>LiveCoding</strong>, <strong>Usar–Modificar–Criar</strong>, <strong>metacognição</strong> e <strong>gamificação</strong>.',
          why:'Os métodos começam a ser usados na <em>segunda aula do curso</em>. Se você encontrar “esta sessão foi estruturada em torno do sistema Scrum” sem saber o que isso significa, vai conduzir a aula como uma aula comum e a estrutura de que ela depende desaparece silenciosamente.',
      ...
      {t:'🕐 A estrutura', cards:[
        ...
        {type:'good', txt:'Use cronômetros visíveis, sempre. Os planos pedem isso em apresentações de um minuto, brainstorms de cinco minutos, caças ao código de dois minutos, rodadas de treino de sete minutos. Um cronômetro na tela garante a disciplina por você, e assim você continua sendo quem ajuda, e não quem apressa.'}
      ]},
      {t:'🎓 Os cinco métodos, pelo nome', cards:[
        {type:'qa', h:'O que cada nome significa quando você o vê no topo de um plano', items:[
          ...
          {k:'LiveCoding', v:'Você constrói o código <strong>junto com os alunos</strong>, compartilhando a tela, narrando decisões e errando de propósito para que eles percebam. <em>Usado nas aulas de banco de dados.</em>'},
          {k:'Usar–Modificar–Criar', v:'Os alunos primeiro <strong>usam</strong> código que funciona, depois o <strong>modificam</strong> enquanto você explica, e só então <strong>criam</strong> o deles. Resista à tentação de explicar cedo demais. <em>Usado no primeiro bot do Discord e no modelo Keras.</em>'},
          ...
          {k:'Gamificação', v:'Teoria apresentada como jogo em vez de exposição — times de quiz, jogos de especialista, caças ao código, competições de acurácia. Não é enfeite; <em>é</em> o método de ensino.'}
        ]},
        {type:'text', h:'Quando você atrasa', b:'A instrução é explícita e vale internalizar desde já: numa aula de EduScrum, se você está atrasado, <strong>vá para a retrospectiva mesmo assim</strong> e discuta o que deu errado. Uma estrutura de aula completa com tarefas inacabadas vale mais do que uma estrutura incompleta. A mesma lógica vale em todo lugar: proteja a estrutura, sacrifique o escopo.'},
        {type:'tip', txt:'Quando um plano nomeia um método, ele está dizendo que a aula não funciona de outro jeito. Uma aula de Usar–Modificar–Criar conduzida como exposição, ou uma de EduScrum sem controle de tempo, faz com que o tempo da etapa seja extrapolado e um grupo desengajado. Leia a nota no topo do plano primeiro, sempre.'}
      ]},
      {t:'🧰 As ferramentas e as duas regras de ouro', cards:[
        {type:'qa', h:'As ferramentas com as quais você conduz uma aula', items:[
          ...
          {k:'Backoffice (BO)', v:'Verificar se as tarefas foram realmente enviadas e obter o link do chat do grupo.'},
        ...
        {type:'good', txt:'<strong>Regra um: nunca escreva o código de um aluno.</strong> Faça perguntas orientadoras, deixe que pensem em voz alta, deixe que se ajudem. Aparece em quase todo plano e é o comportamento que mais distingue um bom tutor aqui.'},
        {type:'good', txt:'<strong>Regra dois: teoria primeiro, código depois.</strong> Diga o que uma linha faz e então digitem juntos. Iniciantes colocados diretamente diante de um script se perdem — o conceito precisa ser assimilado antes da sintaxe.'},
        {type:'tip', txt:'O Módulo 15 cobre o restante do ofício de conduzir aulas — diferenciação, avaliação, gestão de sala, as técnicas de reflexão e o que dizer quando você não sabe uma resposta. Volte a ele depois de dominar os módulos de conteúdo; você vai aproveitar mais.'}
      ]}
    ],
    quiz:[
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Instalar o interpretador Python e confirmar que <code>python --version</code> funciona num terminal novo',
        'Instalar o VS Code e a extensão Python, e usar <em>Python: Select Interpreter</em> ao menos uma vez',
        'Criar uma pasta de projeto e um arquivo <code>.py</code>, e executá-lo pelo terminal do VS Code',
        'Instalar uma biblioteca com <code>pip install</code>, depois criar um ambiente <strong>pipenv</strong> e instalar uma dentro dele',
        'Provocar de propósito um <code>ModuleNotFoundError</code> instalando fora do ambiente — e corrigir',
        'Instalar o Git, rodar <code>git config --global user.name</code> e <code>git config --global user.email</code>, e publicar um repositório <strong>de dentro do VS Code</strong>',
        'Criar e mesclar um branch, e ver a saída do fast-forward merge',
        'Registrar uma aplicação e um bot no Discord, ativar o <strong>Message Content Intent</strong>, convidar o bot para o seu servidor e fazê-lo responder',
        'Criar um notebook no Colab, rodar uma célula de código e uma de markdown, subir um arquivo e ver o reinício da sessão apagá-lo',
        'Treinar um classificador no Teachable Machine, exportar o modelo e descompactá-lo no Colab',
        'Abrir a plataforma como tutor E visualizar uma aula do jeito que o aluno vê',
        'Abrir ao menos três apresentações de aula em modo de exibição'
      ]
    },
    sections:[
      ...
      {t:'📦 pip, pipenv e ambientes virtuais', cards:[
        ...
        {type:'tip', txt:'Uma instalação grande pode demorar muito num notebook escolar. Tenha uma alternativa pronta — o Pipfile do repositório de solução — e saiba que usá-lo é a decisão certa, não uma concessão. A aula é sobre IA, não sobre esperar um download.'}
      ]},
      {t:'🐙 Git, GitHub e branches', cards:[
        {type:'text', h:'A sequência completa para fazer você mesmo', b:'Crie a conta no GitHub. Crie um repositório público vazio e suba um arquivo <strong>pelo site</strong> — o jeito desajeitado que os alunos encontram primeiro em M1L2. Depois instale o <strong>aplicativo git</strong>, escolhendo o VS Code como editor durante a instalação. Rode <code>git config --global user.name</code> e <code>git config --global user.email</code>. Faça login no GitHub de dentro do VS Code — <em>uma vez</em> — e publique um repositório <strong>pelo editor</strong>, do jeito que M2L3 ensina. Por fim, faça um commit de alteração e olhe o histórico do arquivo.'},
      ...
      {t:'🤖 O Discord Developer Portal', cards:[
        ...
        {type:'warn', txt:'Duas coisas para lembrar antes da aula. Primeira: o intent precisa estar ativo <strong>tanto</strong> no código (<code>intents.message_content = True</code>) <strong>quanto</strong> no portal — só um dos dois deixa você com um bot que conecta e ignora tudo. Segunda: o layout do portal muda. Clique por ele de novo pouco antes de dar M1L3, em vez de confiar na sua memória de meses atrás.'},
      ...
      {t:'🖥️ A plataforma e as apresentações', cards:[
        ...
        {type:'image', src:'assets/media/images/setup-platform.jpg', alt:'Página do curso Python Pro na plataforma Kodland, mostrando a barra de título do curso, as abas de tarefas em aula e lição de casa, e os cartões dos módulos.', cap:'A página do curso na plataforma. No menu lateral: <em>Kurslarım</em> = Meus cursos. As abas são <em>Ders İçi Görevler</em> = tarefas em aula, <em>Ödevler</em> = lição de casa (com a contagem de itens esperando por você) e <em>Lider Tablosu</em> = tabela de classificação. Abaixo ficam os cartões dos módulos — <em>Modül 1, 2, 3…</em> — e cada um abre a lista de aulas para onde apontam todas as instruções “vá para a tarefa chamada…”.'},
        {type:'good', txt:'Leia a barra de título do curso nesse print, porque é o resumo mais claro do que você vai ensinar: <strong>[1619] Python Pro [13-17] [90 min] [40 L] [Turkey]</strong> — código do curso 1619, faixa etária de <strong>13 a 17 anos</strong>, aulas de noventa minutos, quarenta delas. O balão de notificação em <em>Ödevler</em> indica as lições esperando correção; é esse número que cresce silenciosamente se você deixar a correção acumular.'},
  ...
  },
  {
    ...
    obj:'Ensine as quatro aulas que transformam um aluno que concluiu o Python Basic em alguém que trabalha como desenvolvedor: revisar sintaxe, registrar e usar o GitHub, instalar uma IDE e um interpretador de verdade, instalar bibliotecas com pip, construir um bot do Discord, extrair a lógica para funções e ler a documentação da biblioteca para estendê-la.',
    ...
    practical:{
      ...
      items:[
        'Escrever o aplicativo de dicionário de gírias com um dicionário de verdade e busca com <code>.keys()</code>',
        'Escrever o gerador de senhas com <code>random.choice</code> dentro de um laço',
        'Extrair esse gerador para <code>bot_logic.py</code> como função e o importar em <code>main.py</code>',
        'Registrar um bot, ativar o Message Content Intent e fazer um bot da classe <strong>Client</strong> responder no seu próprio servidor',
        'Reescrever o mesmo bot usando a classe <strong>Bot</strong>, com <code>@bot.command()</code> e um prefixo',
        'Subir um projeto ao GitHub, alterar, subir de novo e ver o histórico do arquivo',
        'Rodar de propósito um bot com o token removido, para saber como essa falha aparece'
      ]
    },
    sections:[
...
<span class="ck">else</span>:
    <span class="cf">print</span>(<span class="cs">"Ainda não temos essa palavra... mas estamos trabalhando nisso!"</span>)`},
        {type:'hi', h:'Por que explorar os repositórios importa', b:'Depois de subir o código, os alunos postam os links dos repositórios no chat do grupo e saem à caça da palavra mais engraçada que um colega adicionou. É esse o objetivo inteiro da etapa: mostrar a eles, na prática, que o <strong>Git torna o código dos outros instantaneamente acessível</strong>. Dê o exemplo — abra alguns repositórios e comente em voz alta o que cada aluno fez bem.'},
        {type:'tip', txt:'Prepare a próxima aula no fim desta. A lição de casa pede que explorem um projeto no GitHub e tragam 2 ou 3 perguntas sobre ele; peça também que <strong>baixem em casa os instaladores do Python e do VS Code</strong> e deixem um e-mail pronto. Downloads durante a segunda aula vão consumir seu tempo de prática.'}
      ]},
      {t:'💻 L2 — O interpretador, o VS Code e o gerador de senhas', cards:[
        {type:'text', h:'O problema de contextualização', b:'Ataques hacker. Discuta como dados pessoais são roubados e como se proteger — não clicar em links suspeitos, não digitar dados pessoais em sites desconhecidos e <strong>usar senhas fortes</strong>. Esse último vira o projeto: um programa de código aberto que gera senhas fortes.'},
        {type:'qa', h:'Os dois conceitos que precisam se consolidar', items:[
...
<span class="cf">print</span>(password)`},
      ...
      {t:'🤖 L3 — pip, o bot do Discord e funções', cards:[
        {type:'text', h:'Usar–Modificar–Criar', b:'Esta aula segue o <strong>método UMC</strong>, e você precisa fazer os dois primeiros passos em ordem: os alunos <strong>usam</strong> um bot completo (rodam, veem funcionar) e depois o <strong>modificam</strong> enquanto você explica o que cada mudança faz. Dê cinco minutos para experimentarem livremente o código de exemplo e responda a perguntas sem entregar nada.'},
        {type:'qa', h:'pip e as três coisas de que um bot precisa', items:[
          ...
          {k:'1. Um servidor', v:'O bot precisa de um espaço para rodar. Cada aluno cria o próprio servidor no Discord.'},
        ...
        {type:'warn', txt:'Diga isto no momento em que os tokens aparecerem, e toda vez que um projeto for publicado: <strong>se alguém obtiver seu token, terá controle total sobre o seu bot.</strong> Nunca faça commit dele, nunca poste no chat, nunca deixe visível numa tela compartilhada. No código compartilhado escrevemos o marcador <code>bot.run("YOUR_BOT_TOKEN")</code>. Se um token vazar, regenere-o no Developer Portal — apagar o arquivo não basta, porque o Git guarda o histórico.'},
...
<span class="ck">def</span> <span class="cf">gen_pass</span>(pass_length):
    ...
    <span class="ck">return</span> password`},
        {type:'code', lbl:'o bot que importa a lógica — main.py (classe Client)', code:`<span class="ck">import</span> discord
...
client.<span class="cf">run</span>(<span class="cs">"YOUR_BOT_TOKEN"</span>)`},
      ...
      {t:'📖 L4 — Documentação, a classe Bot e teste entre colegas', cards:[
        ...
        {type:'twocol', left:{h:'Client', items:['Reage a <strong>eventos</strong> — <code>@client.event</code>','Lê a <strong>mensagem inteira</strong>, por isso, passar um valor exige que você mesmo divida o texto','Use para interagir com a API como um usuário']}, right:{h:'Bot', items:['Reage a <strong>comandos que você define</strong> — <code>@bot.command()</code>','Aceita diretamente os argumentos que o usuário digita','Use para automatizar ações específicas']}},
...
bot.<span class="cf">run</span>(<span class="cs">"YOUR_BOT_TOKEN"</span>)`},
        {type:'warn', txt:'<strong>Nunca use <code>Bot</code> e <code>Client</code> no mesmo programa.</strong> Alunos que copiam trechos de dois tutoriais diferentes vão fazer exatamente isso e deparar-se com erros confusos. É uma das “5 diferenças” que eles precisam encontrar entre as duas versões do código.'},
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Escrever um bot que envia uma imagem específica com <code>discord.File</code> e o modo <code>\'rb\'</code>',
        'Refiná-lo para escolher um arquivo aleatório com <code>os.listdir</code> — e errar o caminho pelo menos uma vez',
        'Chamar uma API pública com <code>requests</code> e extrair um campo da resposta <code>.json()</code>',
        'Construir uma pequena página HTML com as tags do curso e vincular um <code>style.css</code> a ela',
        'Adicionar uma animação com <code>@keyframes</code> e uma variante <code>:hover</code>',
        'Incorporar um widget de terceiros com <code>&lt;iframe&gt;</code>',
        'Publicar a página no GitHub de dentro do VS Code',
        'Olhar um site propositalmente ruim e anotar você mesmo os problemas de UX e de UI'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
        {type:'brief',
          ...
          confident:'<code>with open()</code> e os modos de acesso a arquivos; <code>os.listdir()</code> com <code>random.choice</code>; <code>discord.File</code>, o que uma API devolve e como <code>requests</code> e <code>.json()</code> lidam com isso; as tags de HTML essenciais; como vincular uma folha de estilos; e <code>git config</code> mais a publicação de um repositório pelo VS Code.'
        }
      ]},
    ...
    <span class="ck">await</span> ctx.<span class="cf">send</span>(<span class="cf">get_duck_image_url</span>())`},
      ...
      {t:'🌐 L3 — Front-end, HTML, CSS e Git no VS Code', cards:[
        ...
        {type:'qa', h:'A distinção que precisa ficar clara', items:[
          ...
          {k:'Por que importa para o Python', v:'HTML e CSS viram <em>templates</em> que o Flask preenche com dados. Conhecê-los é o que permite a um desenvolvedor Python entregar uma página com acabamento profissional.'}
        ]},
...
h1:hover {
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Criar um ambiente com pipenv e instalar o Flask dentro dele',
        'Escrever um app de uma rota devolvendo HTML, com <code>app.run(debug=True)</code>, e abrir no navegador',
        'Adicionar uma segunda rota com URL própria e ligar as duas páginas',
        'Sair de devolver strings para <code>render_template</code> com uma pasta <code>templates/</code> de verdade',
        'Passar uma variável para um template e exibi-la com <code>{{ }}</code> do Jinja',
        'Construir um <code>&lt;form&gt;</code> HTML, ler com <code>request.form</code> e mostrar o resultado em outra página',
        'Quebrar de propósito definindo <code>id</code> sem <code>name</code> e ver o KeyError',
        'Usar <code>url_for()</code> num link e um <code>&lt;select&gt;</code> cujo valor chega ao Python',
        'Baixar um projeto de uma branch do repositório'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
...
<span class="ct2">&lt;/li&gt;</span>`},
      ...
      {t:'🌿 L3 — Branches, url_for e formulários (EduScrum)', cards:[
        {type:'hi', h:'Esta é uma aula de EduScrum — a habilidade é o tempo', b:'A aula é montada como <strong>dois sprints com retrospectivas</strong>. Diga em voz alta o limite de tempo de cada sprint. A observação da aula é direta sobre o modo de falha: se você estiver atrasado, <strong>vá para a retrospectiva mesmo assim</strong> e discuta o que deu errado. Terminar todas as tarefas importa menos do que o grupo vivenciar um ciclo completo de sprint.'},
...
<span class="ck">def</span> <span class="cf">submit_form</span>():
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Instalar o <code>flask_sqlalchemy</code> e definir uma classe de modelo com campos <code>db.Column</code> e uma <code>primary_key</code>',
        'Criar o arquivo <code>.db</code> e salvar um registro com <code>db.session.add()</code> e depois <code>commit()</code>',
        'Omitir o <code>commit()</code> de propósito e confirmar que nada é salvo e nenhum erro aparece',
        'Recuperar registros com <code>.query.all()</code>, <code>.order_by()</code> e <code>.get(id)</code> e os exibir num template',
        'Adicionar uma segunda tabela <code>User</code>, esbarrar no erro “no such table” e corrigir apagando e recriando o <code>.db</code>',
        'Construir cadastro e login, com <code>session</code> e <code>secret_key</code>, e filtrar entradas com <code>filter_by()</code>',
        'Fazer o deploy de um app funcionando no <strong>PythonAnywhere</strong>, inclusive editando o arquivo WSGI, e abrir no celular',
        'Quebrar o deploy de propósito e achar a causa no log de erros',
        'Treinar em voz alta a ressalva de uma frase sobre hash de senhas'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
...
<span class="ck">return</span> <span class="cf">render_template</span>(<span class="cs">'card.html'</span>, card=card)`},
      ...
      {t:'🔑 L2 — Usuários, cadastro e login', cards:[
        {type:'text', h:'O que a aula constrói', b:'Baixe o projeto atualizado da <strong>branch</strong> dele, acrescente uma segunda tabela para usuários, adicione campos de login e senha ao <code>login.html</code>, salve um usuário cadastrado e então confira o login enviado no banco. Cada etapa consolida algo da L1 — esta aula é deliberadamente uma repetição das mesmas habilidades sobre conteúdo novo.'},
...
<span class="ck">return</span> <span class="cf">render_template</span>(<span class="cs">'login.html'</span>, error=error)`},
      ...
      {t:'🚀 L3 — Deploy no PythonAnywhere (EduScrum)', cards:[
        ...
        {type:'good', txt:'Este é um momento muito gratificante para destacar em voz alta. Um aluno já pode mandar um link a um amigo ou a um responsável e vê-lo usar aquilo que ele construiu. Peça que façam isso — um público fora da sala é a motivação mais forte disponível para você.'}
      ]},
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Montar um notebook no Colab com células de código e de markdown, e enviar imagens para a sessão',
        'Remover o fundo de uma imagem com <code>rembg</code> e compor um novo fundo com OpenCV',
        'Escrever texto sobre uma imagem com OpenCV',
        'Abrir as ferramentas de desenvolvedor do navegador e identificar a tag e a classe que contêm um trecho de conteúdo da página',
        'Fazer scraping de uma página com <code>BeautifulSoup</code> e depois transformar isso num crawler sobre várias seções',
        'Montar um <code>DataFrame</code> do pandas e salvá-lo com <code>to_csv</code> — e guardar o arquivo',
        'Rodar o sumarizador do NLTK de ponta a ponta, incluindo <code>stopwords</code> e <code>FreqDist</code>',
        'Treinar um classificador no Teachable Machine e testá-lo com uma imagem que ele nunca tinha visto',
        'Treinar de propósito um modelo ruim e vê-lo errar com toda a confiança'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
      ...
      {t:'🔬 L1 — Mitos sobre IA, Colab e fundos de imagem', cards:[
        ...
        {type:'text', h:'Google Colab, em dez minutos', b:'Os alunos entram com uma conta Google, criam um notebook <code>.ipynb</code> no Drive e rodam <strong>duas ou três células de código e uma de markdown</strong>. Garanta que todos consigam criar uma célula e executá-la — esse é o único critério de sucesso. Depois mostre como enviar imagens para a sessão atual e, no fim da aula, como <strong>compartilhar</strong> um notebook com permissão de visualizar ou editar.'},
...
df_news.<span class="cf">to_csv</span>(<span class="cs">"./saved_data.csv"</span>, index=<span class="ck">False</span>)`},
    ...
    <span class="ck">return</span> <span class="cs">' '</span>.<span class="cf">join</span>([sentences[i] <span class="ck">for</span> i, _ <span class="ck">in</span> best])`},
      ...
      {t:'👁️ L4 — Visão computacional e o classificador', cards:[
        ...
        {type:'good', txt:'A explicação do vencedor é o minuto mais valioso da aula. Ele quase sempre vai dizer “eu adicionei mais imagens” ou “eu adicionei mais variedade” — que é o objetivo principal da aula, alcançado por meio da experimentação e não por mera teoria. Deixe que ele ensine.'},
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Exportar um modelo do Teachable Machine, descompactar no Colab e carregar com <code>tf_keras</code>',
        'Esbarrar no erro de versão do <code>DepthwiseConv2D</code> e corrigir com as versões fixadas',
        'Escrever uma função que recebe uma imagem e devolve um nome de classe e uma confiança',
        'Confirmar que o modelo força uma imagem sem relação para dentro de uma das classes conhecidas',
        'Gerar imagens com prompts e montar um dataset de duas classes com imagens geradas e reais',
        'Rodar detecção com <code>ImageAI</code>/YOLOv3 e filtrar os resultados pelo nome do objeto',
        'Comparar a detecção numa foto poluída e numa foto limpa, para ver por que o fundo importa',
        'Construir um pequeno script próprio de ponta a ponta que usa um modelo para resolver um problema inventado'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
      ...
      {t:'⚙️ L1 — Rodando o modelo pelo código (Keras)', cards:[
        {type:'text', h:'Usar–Modificar–Criar de novo', b:'Esta aula segue a metodologia <strong>UMC</strong>: os alunos primeiro <em>usam</em> o código que o Teachable Machine entrega e conferem que funciona, e só então implementam a própria lógica em cima dele. Mostre como exportar o modelo, adicionar o projeto baixado à sessão do Colab e descompactar com <code>!unzip ./converted_keras.zip</code>. Para uma turma forte, conecte o Google Drive em vez disso.'},
...
model = <span class="cf">load_model</span>(<span class="cs">"PATH_TO_MODEL"</span>, compile=<span class="ck">False</span>)`},
        ...
        {type:'hi', h:'O jogo “todos contra um”', b:'Depois de cinco minutos explorando o código, um aluno vira o <strong>especialista</strong> e responde às perguntas de todos os outros. As perguntas podem ser simples ou difíceis, e tudo bem se quem pergunta também não souber a resposta. Se o especialista empacar, você responde. O especialista vence se responder a tudo; caso contrário a vitória vai para quem fez mais perguntas sem resposta. O real objetivo dessa dinâmica: isso <strong>ajuda os alunos a superar o medo de formular uma pergunta</strong>. Reforce que não existe pergunta boba.'},
        {type:'warn', txt:'Destaque isto depois do jogo: o modelo <strong>só</strong> consegue distinguir as classes com que foi treinado. Mostre outra coisa a ele e ainda assim tentará classificá-la, com total confiança, em uma das classes conhecidas. É o mal-entendido mais comum que os alunos têm sobre IA, e aqui eles podem ver acontecer.'},
      ...
      {t:'🎨 L2 — Gerado contra real: a competição de IA', cards:[
        ...
        {type:'qa', h:'As regras da competição', items:[
          ...
          {k:'Equipes', v:'Você é quem monta, de 3 a 4 alunos cada; os alunos não escolhem. Cada equipe escolhe seu nome e escolhe um capitão.'},
        ...
        {type:'text', h:'Engenharia de prompt, em uma frase', b:'A instrução enviada a um modelo generativo é chamada de <strong>prompt</strong>, e engenharia de prompt é o ofício de escrever bons prompts: um bom prompt deixa sua intenção clara para o modelo, então você recebe uma resposta mais precisa ou um conteúdo melhor. As equipes geram de 8 a 20 imagens para a classe “gerada”, depois baixam fotos reais para uma pasta “real” separada e enviam as duas para a pasta compartilhada da equipe.'},
        {type:'good', txt:'A regra da “maior média da equipe” é o detalhe mais bem planejado desta aula. Ela elimina o incentivo de guardar uma boa técnica para si e o substitui pelo incentivo de ensiná-la. Se você não mudar mais nada na forma de conduzir essa competição, mantenha essa regra.'},
      ...
      {t:'🔍 L3 — Detecção, segmentação e a carta', cards:[
        {type:'text', h:'O enquadramento gamificado', b:'A aula abre com uma <strong>carta comercial</strong> encomendando um app de segurança viária. Se seus alunos entrarem no jogo, trate como um e-mail de cliente de verdade; se eles estiverem tímidos demais, use apenas para destrinchar a estrutura. De qualquer forma, faça com que leiam e identifiquem os blocos lógicos.'},
...
<span class="ck">def</span> <span class="cf">analyze_objects</span>(detections):
    ...
    <span class="ck">return</span> [d <span class="ck">for</span> d <span class="ck">in</span> detections <span class="ck">if</span> d[<span class="cs">"name"</span>] <span class="ck">in</span> road]`},
      ...
      {t:'🛠️ L4 — Construindo a própria solução (EduScrum)', cards:[
        ...
        {type:'text', h:'Fim do Tópico 3 — a carreira de cientista de dados', b:'Feche o tópico de IA conectando-o a uma carreira, e pergunte o que eles sabem antes de contar. O enquadramento que o curso oferece: uma carreira de cientista de dados é uma detetive da informação no mundo digital — coleta os dados, limpa-os para que fiquem corretos e então usa ferramentas especializadas para achar padrões e respostas. Depois pergunte quem se sente atraído por isso e se isso se alinha com os seus outros interesses.'}
      ]}
    ],
    quiz:[
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Montar um ambiente virtual com as bibliotecas de IA instaladas e o interpretador certo selecionado',
        'Fazer um bot aceitar uma imagem anexada e salvá-la com <code>attachment.save()</code>',
        'Ligar o seu próprio modelo exportado a esse bot para que ele responda com uma previsão',
        'Publicar o projeto inteiro pelo VS Code — depois de remover o token',
        'Escrever um README bom o bastante para tirar 30 pelos critérios do próprio curso',
        'Gravar e transcrever fala com <code>sounddevice</code> e <code>speech_recognition</code>',
        'Esbarrar na falha do microfone ocupado e confirmar que silenciar o Zoom resolve',
        'Adicionar tradução ao script de transcrição',
        'Adicionar uma rota funcional de entrada por voz ao seu app Flask, dentro de <code>try</code>/<code>except</code>'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
...
<span class="ck">async def</span> <span class="cf">check</span>(ctx):
    ...
    <span class="ck">else</span>:
        ...
        {type:'text', h:'O brainstorm e a checagem de mercado', b:'Uma atividade em três passos, com etapas opcionais se o tempo estiver curto. <strong>1. Brainstorm</strong> — os alunos geram ideias de um bot do Discord tipo startup que use classificação de imagens, sem avaliação durante a geração; você registra todas as ideias num lugar visível a todos. Depois de quatro minutos, formem equipes de 2 a 3 e atribua a cada uma a ideia mais viável. <strong>2. Análise de mercado</strong> — oito minutos para procurar soluções parecidas já existentes e listar vantagens e desvantagens da ideia atribuída, escrevendo os achados no chat da tarefa. <strong>3. Apresentação</strong> — cada equipe compartilha o que encontrou.'},
        {type:'good', txt:'A etapa de análise de mercado é discretamente a parte mais madura do curso. A maioria dos alunos nunca verificou se a ideia deles já existe — e descobrir que existe, e que tem falhas, motiva mais do que desanima. Enquadre como reconhecimento de terreno, não como julgamento.'}
      ]},
      {t:'🧩 L2 — Inferência no bot e publicação pelo VS Code', cards:[
        {type:'text', h:'O que significa inferência', b:'Introduza o termo diretamente: <strong>inferência</strong> é usar um modelo já treinado para fazer uma previsão sobre uma entrada nova. O treino acabou; este é o modelo realizando o seu trabalho. A tarefa é acrescentar o modelo e o arquivo <code>labels.txt</code> ao projeto, descobrir quais arquivos são necessários e por quê, e então fazer o bot responder a uma imagem enviada com a saída do modelo.'},
...
<span class="ck">async def</span> <span class="cf">check</span>(ctx):
    ...
    <span class="ck">else</span>:
        ...
        {type:'warn', txt:'A checagem do token, de novo e para valer: este projeto agora contém um token de bot <em>e</em> um modelo treinado. Antes de qualquer push, o token deve ser removido. Um repositório público com um token ativo é o pior desfecho que este curso pode produzir — e esta é a aula em que isso é mais provável, porque os alunos estão focados na parte de IA.'}
      ]},
...
<span class="ck">except</span> sr.<span class="ct2">RequestError</span> <span class="ck">as</span> e:
    <span class="cf">print</span>(<span class="cs">f"Erro do serviço: {e}"</span>)`},
        {type:'warn', txt:'A coisa mais útil deste plano de aula: <strong>se o script der erro, silencie seu microfone no Zoom e rode de novo.</strong> O Zoom bloqueia o acesso ao microfone e o script não consegue abri-lo. Diga isso aos alunos antes da primeira execução, e não depois de vinte minutos depurando.'},
        {type:'text', h:'Depois acrescente a tradução', b:'Segunda metade: estenda o script para que o texto transcrito seja traduzido para outro idioma com a classe <code>Translator</code>, e deixe o usuário escolher o código do idioma de destino. As duas partes são feitas por <strong>live coding</strong> — vocês constroem juntos — e o critério de sucesso é declarado sem rodeios: ao fim da etapa, <strong>todo aluno tem código funcionando</strong>.'},
      ...
      {t:'🗣️ L4 — Entrada por voz no app Flask', cards:[
        {type:'text', h:'O objetivo, e a liberdade que você tem', b:'Acrescentar um <strong>botão de entrada por voz</strong> que aparece quando o usuário cria um novo registro no diário. O manual da aula é explícito ao dizer que a implementação sugerida é uma opção simples — e não a mais eficaz — entre várias. Você tem liberdade para implementar de outro jeito conforme o nível dos seus alunos. Diga isso a turmas fortes; elas vão desenvolver algo melhor.'},
        {type:'text', h:'Comece por perguntas, não por código', b:'Peça que relembrem de que é feita uma página web e em qual página o botão deve ficar. Mostre o template e peça para que encontrem a classe já definida para botões. Depois o ponto sutil: o <code>&lt;button&gt;</code> dentro de um formulário <strong>envia o formulário</strong>, e não é isso que queremos — queremos que rode a nossa função. É por isso que o exemplo usa um link estilizado.'},
...
<span class="ct2">&lt;/label&gt;</span>`},
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Explicar Agile e Scrum em voz alta, com suas próprias palavras, usando as analogias do dia a dia',
        'Escrever um plano de sprint para um recurso pequeno, dividido em tarefas com responsáveis',
        'Criar uma branch, fazer commits nela, integrá-la e ler a saída do merge',
        'Criar de propósito um <strong>conflito</strong> de merge e resolvê-lo — para que não te surpreenda ao vivo',
        'Revisar o código de exemplo com bugs do curso e achar você mesmo os quatro problemas plantados',
        'Escrever um checklist próprio de code review antes de compará-lo ao do curso',
        'Instalar a extensão <strong>Live Share</strong> e rodar uma sessão com um segundo aparelho ou com um colega',
        'Refatorar o código quebrado da tarefa colaborativa até funcionar'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
      ...
      {t:'🏃 L1 — Agile, Scrum e planejamento de sprint', cards:[
        {type:'text', h:'Ensine os valores por analogias do cotidiano', b:'Faça uma pausa nos valores do Agile e peça aos alunos que expliquem cada um com as próprias palavras e um exemplo da vida diária. O curso fornece quatro analogias que funcionam bem com adolescentes, e usá-las é melhor do que definir os termos.'},
        ...
        {type:'twocol', left:{h:'Scrum Master', items:['Remove obstáculos para que o time consiga trabalhar','Explica Agile e Scrum, principalmente a quem chega','Conduz dailys, planejamentos e retrospectivas — e as mantém produtivas','Garante que as pessoas se sintam seguras para expressar ideias, e traz os mais quietos para a conversa','<strong>Não comanda</strong> — cria as condições para o sucesso']}, right:{h:'Product Owner', items:['Reúne requisitos de clientes, gestores e usuários','Monta a lista de tarefas e a ordena por prioridade','Escreve as tarefas como histórias de usuário que o time entende','Define quando uma tarefa conta como concluída','Ajuda o time a quebrar tarefas e avaliar a complexidade']}},
 ...
 1 file changed, 2 insertions(+), 1 deletion(-)`},
      ...
      {t:'🔎 L3 — Code review', cards:[
        ...
        {type:'qa', h:'Os cinco princípios de uma revisão eficaz', items:[
          ...
          {k:'Dê recomendações claras', v:'Deixe suas sugestões o mais claras possível.'}
        ]},
...
<span class="ck">while</span> <span class="ck">True</span>:
    ...
    <span class="ck">elif</span> user_guess &lt; secret:            <span class="cc">#    texto digitado derruba tudo</span>
      ...
      {t:'👥 L4 — Desenvolvimento colaborativo e o jogo do módulo', cards:[
        ...
        {type:'text', h:'A tarefa colaborativa', b:'Carregue um código propositalmente quebrado no ambiente compartilhado e ajude os alunos a <strong>dividir as correções entre si</strong>. Diga que não precisam terminar tudo, mas devem melhorar o quanto conseguirem. Vinte minutos e então parem para trocar impressões. Os problemas plantados servem como uma excelente revisão do curso: uma função que calcula mas nunca faz <code>return</code>, entrada sem validação, ausência de tratamento de exceções ao redor do <code>int(input(...))</code>, uma variável que por consequência recebe <code>None</code> e um nome de jogador coletado e nunca usado.'},
...
<span class="ck">if</span> __name__ == <span class="cs">"__main__"</span>:
    <span class="cf">main</span>()`},
        ...
        {type:'tip', txt:'Cumpra os tempos com rigor aqui: 5 minutos explicando e formando equipes, 15 minutos trabalhando, 5 + 5 minutos apresentando. Esta aula tem quatro etapas distintas, sem tempo a perder.'}
      ]}
    ],
    quiz:[
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Instalar o <code>pyttsx3</code> e fazer a sua máquina falar, ajustando velocidade, volume e voz',
        'Confirmar quais índices de voz de fato existem no seu sistema operacional',
        'Chamar o <code>wttr.in</code> e receber uma previsão formatada de volta',
        'Construir o bot falante de previsão do tempo nas três etapas que a aula usa',
        'Confirmar que a fala sai da máquina que roda o bot, e não do Discord',
        'Construir sozinho um segundo bot falante a partir de outra API, para testar seu próprio tempo',
        'Refatorar você mesmo os exemplos bagunçados de imposto e de pontos de casa antes de ler as soluções',
        'Instalar o <code>flake8</code>, rodar no próprio código e corrigir o que ele apontou',
        'Achar no seu código um problema que o flake8 não conseguiu pegar'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
        {type:'brief',
          ...
          learn:'Os alunos distinguem controle por voz, reconhecimento e síntese; instalam e configuram uma biblioteca de síntese; constroem um bot falante de previsão do tempo usando uma API sem chave; constroem sozinhos um segundo bot falante; e refatoram código bagunçado contra critérios de código limpo, verificando com um linter.',
...
engine.<span class="cf">runAndWait</span>()                     <span class="cc"># de fato executa a síntese</span>`},
        {type:'text', h:'A etapa de trabalho autônomo', b:'Esta é uma etapa genuinamente autônoma de 40 minutos: 25 minutos para estudar a documentação e construir um programa para vocalizar texto e experimentar as configurações, e depois 15 minutos de apresentação. Seu papel é responder a dúvidas organizacionais e técnicas — nada além disso. Se um aluno travar, peça que compartilhe a tela e ajude individualmente. <strong>A prioridade é que todo aluno termine com um programa de fala funcionando</strong>, e você elogia cada apresentação.'},
...
<span class="ck">async def</span> <span class="cf">fact</span>(ctx):
    ...
    <span class="cf">speak</span>(random_fact)`},
        ...
        {type:'tip', txt:'A aula abre com um teste no Tally em que os alunos veem as respostas corretas e os comentários ao terminar. Diga isso de antemão — muda o teste de um obstáculo a ser superado para uma oportunidade de aprendizado. E lembre-os no fim de preparar um projeto para o code review da próxima aula.'}
      ]},
      {t:'🧼 L4 — Código limpo, refatoração e flake8', cards:[
        {type:'text', h:'O que é código limpo, e a definição a dar', b:'Código <strong>fácil de ler, entender e manter</strong> — escrito visando qualidade e estrutura, e não velocidade ou esforço mínimo. Passe dez minutos discutindo as perguntas do slide antes de qualquer código; alunos que acabaram de passar um módulo revisando o trabalho uns dos outros têm opiniões que vale a pena ouvir.'},
        {type:'qa', h:'Por que importa — as razões a que os alunos devem chegar', items:[
          ...
          {k:'Menos erros', v:'Código bem estruturado esconde menos bugs, então gasta-se menos tempo com depuração.'},
...
<span class="cf">print</span>(<span class="cs">"Preço final:"</span>, final_price)`},
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Conduzir um brainstorm até uma decisão definida — mesmo sozinho, no papel, para sentir o formato',
        'Escolher um tipo de projeto para uma ideia e escrever por que aquele tipo se encaixa',
        'Preparar um pitch de um minuto de um projeto usando as oito regras de apresentação, e cronometrar',
        'Escrever um checklist de testes usando os cinco passos e testar um projeto seu usando o checklist',
        'Clonar um projeto que não escreveu, montar o ambiente dele e o colocar para rodar',
        'Escrever um feedback em três partes — pontos positivos, erros e recomendações — sobre o código de outra pessoa',
        'Reler suas construções dos Módulos 5 a 13, porque os alunos vão perguntar sobre qualquer uma delas'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
      ...
      {t:'🌍 L1 — O briefing, o brainstorm e a decisão', cards:[
        ...
        {type:'good', txt:'Fazê-los assumir a ideia no README em vez de no chat é um detalhe pequeno e excelente. É público, é permanente, e faz a próxima aula começar com todo mundo tendo uma ideia declarada, e não uma intenção vaga. Não deixe essa etapa passar.'},
      ...
      {t:'🎤 L2 — Apresentar, construir e o checklist', cards:[
        ...
        {type:'text', h:'As oito regras de apresentação', b:'Peça que os alunos leiam as regras e digam quais estão vendo pela primeira vez, e então apliquem na hora: <strong>um minuto</strong> cada para apresentar a ideia e os resultados da lição de casa, com cronômetro na tela. Se achar que vão travar, <strong>comece você</strong> — faça um pitch de um minuto de um projeto seu e destaque os pontos principais.'},
      ...
      {t:'🏁 L3 — Testes entre colegas, feedback e preparação da formatura', cards:[
        ...
        {type:'text', h:'A abertura honesta', b:'Cada aluno usa <strong>um minuto para descrever o principal problema do próprio projeto</strong> — não os recursos, o problema. Cronômetro ligado, ordem combinada antes. Isso cria um clima em que estar travado é normal e aceitável, que é exatamente o que você precisa na última semana antes da formatura.'},
  ...
  },
  {
    ...
    practical:{
      ...
      items:[
        'Dizer em voz alta o roteiro do “não sei, vamos descobrir” até soar natural, e não como desculpa',
        'Pegar um plano de aula de 90 minutos e escrever a versão individual de 50 minutos dele',
        'Avaliar um trecho de código que funciona pela metade contra os critérios do curso e justificar a nota',
        'Escolher três técnicas de reflexão que você consegue conduzir sem preparo nenhum',
        'Escrever sua própria lista de tarefas adicionais para quem termina rápido, por módulo'
      ]
    },
    sections:[
      {t:'🧭 Visão geral e objetivos', cards:[
      ...
      {t:'🙋 Quando você não sabe a resposta', cards:[
        ...
        {type:'qa', h:'Os três movimentos, e quando usar cada um', items:[
          {k:'Pesquisar junto — o padrão', v:'“Ótima pergunta, não tenho certeza. Vamos descobrir — onde a gente procuraria?” E então faça isso de verdade, compartilhando sua tela. É a opção mais forte porque <em>é</em> a aula M1L4: ninguém sabe de cor uma biblioteca, e achar a resposta é a habilidade profissional. Você não está encobrindo uma lacuna; está demonstrando exatamente o que deveria ensinar.'},
        ...
        {type:'warn', txt:'O único movimento que de fato te custa a sala é <strong>chutar com confiança</strong>. Os alunos testam respostas — eles vão colar aquilo num buscador durante a aula. Estar errado soando seguro é o que encerra sua credibilidade; dizer “não sei” nunca a destrói. Diga isso em voz alta algumas vezes antes da primeira aula, até parar de soar como confissão.'},
      ...
      {t:'🧑‍🤝‍🧑 Gestão de sala com adolescentes online', cards:[
        {type:'qa', h:'As situações que você vai encontrar de verdade', items:[
          ...
          {k:'Um aluno domina tudo', v:'Use as estruturas em vez da sua autoridade: o jogo da “bola”, em que quem fala escolhe quem fala em seguida, a regra de que o mesmo aluno não responde duas vezes seguidas, e pedir a opinião de um aluno mais quieto pelo nome. Deixe que o próprio formato defina o limite.'},
          {k:'Um aluno atrapalha ou está disperso', v:'Dê a ele uma tarefa. Neste curso isso é fácil — peça que conduza uma instalação, compartilhe a tela ou explique a solução dele. Atrapalhar costuma ser sinal de estar subocupado, e o curso é cheio de papéis legítimos para distribuir.'},
          ...
          {k:'Ninguém responde à sua pergunta', v:'Quase sempre a pergunta foi grande demais. Encolha: em vez de “como resolveríamos isso?”, “que tipo esta variável deveria ter?”. Os planos modelam isso o tempo todo com perguntas diretas e fáceis de responder.'},
          {k:'Um aluno fica em silêncio a aula inteira', v:'Anote e aja na aula seguinte — a verificação da lição é a sua forma de identificar quem está se desengajando. Pergunte algo que você sabe que ele consegue responder, para que a primeira coisa que ele diga seja um acerto.'}
        ]},
      ...
      {t:'⚖️ Diferenciação', cards:[
        ...
        {type:'good', txt:'O melhor movimento de diferenciação do curso é transformar um aluno rápido em professor. Aprofunda a compreensão dele, ganha tempo para você com quem travou e não custa nada. Elogie o <em>explicar</em>, não o terminar — é isso que torna aquilo uma recompensa, e não uma tarefa extra.'}
      ]},
      ...
      {t:'💭 As oito técnicas de reflexão', cards:[
        {type:'text', h:'Alterne entre elas — essa é a instrução', b:'Os planos das aulas mais avançadas trazem oito técnicas e recomendam usar <strong>uma diferente a cada aula</strong>. Mantê-las em rodízio é o que impede que os dez minutos finais virem um ritual pelo qual os alunos apenas passam sem engajamento. Tenha três ou quatro que você consiga conduzir sem preparo.'},
      ...
      {t:'✍️ Avaliar código que funciona pela metade', cards:[
        {type:'text', h:'O problema que os critérios não resolvem', b:'O curso te dá pontuações — 30 para funções que funcionam, 35 com a tarefa adicional, <strong>0 se o código não funciona</strong>, até 50 para um projeto de módulo, e a escala de README de 20/30/+5/+10. O que ele não te diz é o que fazer no caso mais comum: o raciocínio está certo, a estrutura está certa, e o código apresenta um erro na linha 14.'},
        {type:'qa', h:'Uma forma defensável de decidir', items:[
          ...
          {k:'Deixe sempre um caminho até os pontos', v:'Diga o que faria a nota subir. Toda tarefa avaliada manualmente pode, em teoria, ser reenviada, porque o curso inteiro é iterativo — a próxima aula constrói sobre o mesmo projeto.'}
        ]},
        {type:'good', txt:'Um hábito útil: escreva o feedback primeiro e a nota depois. Se você não consegue explicar o número em duas frases que ajudariam o aluno a melhorar, provavelmente é o número errado.'},
      ...
      {t:'👤 A aula individual de 50 minutos', cards:[
        ...
        {type:'twocol', left:{h:'O que precisa sair', items:['<strong>Salas simultâneas</strong> — não há com quem formar dupla','<strong>Competições em equipe</strong> — a regra da média de equipe de M6L2 perde o sentido','<strong>Revisão e testes entre colegas</strong> — <em>você</em> vira quem revisa','<strong>Apresentações ao grupo</strong> — viram uma conversa com você','<strong>Jogos que exigem times</strong> — jogo da velha em times, o jogo da “bola”','A maior parte das etapas de troca de ideias e votação']}, right:{h:'O que você ganha, e deve usar', items:['<strong>Ritmo realmente ajustado</strong> — sem esperar o mais lento ou o mais rápido','<strong>Diálogo contínuo</strong> — dá para perguntar “por quê?” a cada passo','<strong>Depuração mais profunda</strong> — ler cada erro junto, com calma','<strong>Foco no projeto dele</strong> — o enquadramento real pode ser escolhido sob medida','Mais tempo nas tarefas adicionais','Retorno imediato e específico em vez de correção acumulada']}},
  ...
  },
  {
    ...
    practical:{
      intro:'Antes de marcar como concluído — e destravar o Teste de Habilidades Digitais:',
      items:[
        'Assistir à aula modelo uma vez do início ao fim, e depois de novo acompanhando o guia de observação',
        'Anotar, palavra por palavra, as frases que a pessoa usa quando um aluno quer a resposta pronta',
        'Listar as seis qualidades de condução abaixo e anotar o momento em que cada uma acontece',
        'Encontrar as duas etapas que <strong>faltam</strong> nesta aula e escrever as frases que você teria dito no lugar',
        'Abrir o plano da aula M1L2 ao lado do vídeo e o comparar com a tabela de etapas',
        'Conferir as suas próprias listas <strong>✋ Antes de ensinar isto</strong> em todos os módulos e fechar tudo o que tinha pulado'
      ]
    },
    ...
    sections:[
      ...
      {t:'✅ O que esta pessoa faz bem — copie isto', cards:[
        {type:'qa', h:'Seis comportamentos concretos, e o que faz cada um funcionar', items:[
          ...
          {k:'Pede que os alunos expliquem, em vez de explicar', v:'Pergunta a eles o que <em>é</em> um interpretador, e eles respondem com as próprias palavras. É a regra do “não dê a resposta” aplicada à teoria, e é o comportamento a ser adotado acima de todos os outros aqui.'}
        ]},
        {type:'good', txt:'Repare também em como é o feedback: a pessoa percorre o código dos alunos junto com eles, ajudando-os a encontrar e corrigir os próprios erros em vez de consertar por eles. É o hábito de depuração de M1L4 sendo modelado duas aulas antes de ser formalmente ensinado.'},
        {type:'text', h:'E a lição de casa é passada corretamente', b:'A tarefa — achar bots do Discord e trazer na próxima aula — é <strong>explicada</strong>, e não apenas anunciada, e é ligada ao que a próxima aula vai fazer com aquilo. Essa ligação para a frente é o que faz a lição de casa parecer parte de algo em vez de um apêndice, e está em todos os planos de aula exatamente por isso.'}
      ]},
      {t:'🕳️ As duas etapas que faltam', cards:[
        {type:'text', h:'O que não está ali', b:'Duas das sete partes do esqueleto da aula não aparecem: <strong>nenhum objetivo claro é enunciado</strong> no começo ou perto dele, e <strong>nenhuma retomada ou revisão fecha a aula</strong>. Estas são duas etapas obrigatórias em cada um dos 40 planos de aula, e o plano de M1L2 tem ambas — um slide de objetivos listando o que o dia produz e uma etapa de reflexão com perguntas de revisão.'},
        {type:'twocol', left:{h:'Por que a etapa de objetivos importa', items:['Alunos que sabem o destino toleram um percurso difícil — e esta aula tem um percurso difícil','Trabalho de configuração parece burocracia até ser ligado a um propósito','O próprio slide de objetivos do plano de M1L2 nomeia quatro resultados, incluindo o gerador de senhas fortes','Sem ele, “por que estamos digitando comandos num terminal?” fica sem resposta']}, right:{h:'Por que a retomada importa', items:['A reflexão é onde a aula se consolida — está no cronograma, não é opcional','É sua última chance de identificar um aluno que apenas balançou a cabeça sem entender','As perguntas de revisão puxam de propósito o aluno mais quieto','Uma aula que para em vez de fechar não deixa nenhuma base sobre a qual construir na semana seguinte']}},
        {type:'good', txt:'Seja justo sobre por que isso acontece: quase sempre é <strong>falta de tempo</strong>. Aulas de configuração estouram — instalações falham, máquinas diferem, um aluno fica para trás — e as etapas das duas pontas são as que são espremidas. É exatamente o modo de falha sobre o qual o Módulo 3 alerta, e ver isso acontecer com uma pessoa competente deveria servir de alerta de que também vai acontecer com você, a menos que você proteja ativamente essas etapas.'},
        {type:'tip', txt:'Sua tarefa: escreva as duas coisas que faltam. Uma <strong>abertura de 30 segundos</strong> dizendo o que esta aula produz e um <strong>fechamento de 2 minutos</strong> com três perguntas de revisão e a lição de casa. Escreva por extenso, com as suas palavras. Esses dois roteiros curtos são o recurso mais prático que você vai levar deste módulo — funcionam em todas as aulas do curso e você pode reaproveitá-los quase sem mudança.'}
      ]},
      {t:'🔍 Sua tarefa de observação', cards:[
        {type:'qa', h:'Etapa por etapa, enquanto assiste', items:[
          ...
          {k:'Teoria', v:'Quão curta ela é? Observe especificamente a pergunta sobre o interpretador — a pessoa pergunta em vez de explicar. Cronometre quanto tempo a teoria de fato dura.'},
          {k:'Prática', v:'Conte quantas vezes a resposta é solicitada ao aluno e ele não sabe responder. Anote o que ela diz no lugar.'},
